...
- Summary: Closed first-release product-contract state, explicit v1 scope
  ...
  Super-Admin-promotion/lifecycle and Course Participant collection/detail plus
  Admin-assisted Module Selection subsets, and the remaining product
  implementation gap.
...
- Summary: Participant registration, profile and global access state, Course
  Assignments, shared Course Invites, Course Participant administration,
...
- Summary: Minimal Course/Group/Module data, IANA timezone semantics, Group and
  Module lifecycle, Group and Module retained-reference deletion, Module
  descriptive editing, pre-start rescheduling and terminal cancellation, and

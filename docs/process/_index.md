...
- Summary: Current process rules, layered Admin/Course creation/editing and
  ...
  administration/onboarding, Admin User directory/name editing/promotion, and
...
- Summary: Defines the layered regression harness, canonical `pnpm check`
  ...
  administration/onboarding, Admin-User-directory/name-editing/promotion, terminal Course-

...
- Summary: Current process rules, layered Admin/Course-structure,
  Participant-registration, direct-Assignment, and application-shell
  verification; active state; and known gaps.
...
- Summary: Defines the layered regression harness, canonical `pnpm check`
  ...
  shell, Course-structure, Participant, and direct-Assignment browser and

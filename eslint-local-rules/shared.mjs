...
export const indexFilePattern = /^index\.(?:mjs|js|jsx)$/u;

const sourceFileExtensions = new Set([".js", ".mjs", ".jsx"]);
const testFilePattern = /\.(test|spec)\.(?:mjs|js|jsx)$/u;
...
/**
 * Return whether a relative directory sits under an app or package workspace.
 *
 * @param {string} relativeDir The repository-relative directory path.
 * @returns {boolean} Whether the directory belongs to a workspace code tree.
 */
export function isWorkspaceCodeDirectory(relativeDir) {
